...
namespace Plain.AspNetCore.NHibernateIdentity
{
    public class UserStore<TUser, TRole> :
        UserStoreBase<TUser, TRole, int, IdentityUserClaim, IdentityUserRole, IdentityUserLogin, IdentityUserToken, IdentityRoleClaim>,
        IProtectedUserStore<TUser> where TUser : DynamoCode.Core.Domain.Identity.IdentityUser where TRole : DynamoCode.Core.Domain.Identity.IdentityRole
    {
